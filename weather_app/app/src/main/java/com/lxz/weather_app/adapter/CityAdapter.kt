...
import com.lxz.weather_app.activity.MainActivity
import com.lxz.weather_app.databinding.CityViewholderBinding
...
class CityAdapter: RecyclerView.Adapter<CityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CityAdapter.ViewHolder, position: Int) {
        ...
        binding.cityTxtViewholder.text = differ.currentList[position].name
        binding.root.setOnClickListener{
            ...
            Log.d("CityAdapter", "City Selected: ${differ.currentList[position].name}, Lat: ${differ.currentList[position].lat}, Lon: ${differ.currentList[position].lon}")
